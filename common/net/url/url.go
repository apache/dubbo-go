...
// This package is an extension of the GO SDK
import (
	"errors"
	"fmt"
	"sort"
...
// If value is not "", it will replaces existing values.
...
// Add adds the value to key. If value is not "", it appends to existing
