...
// GetTpsLimiter find the TpsLimiter with name
...
// SetTpsLimitStrategy set the TpsLimitStrategyCreator with name
func SetTpsLimitStrategy(name string, creator filter.TpsLimitStrategyCreator) {
	tpsLimitStrategy[name] = creator
}

// GetTpsLimitStrategyCreator find the TpsLimitStrategyCreator with name
