...
var (
	valuePatterns = make(map[string]func() pattern.ValuePattern)
)

// SetValuePattern sets create valuePattern function with @name
func SetValuePattern(name string, fun func() pattern.ValuePattern) {
...
func GetValuePatterns() map[string]func() pattern.ValuePattern {
