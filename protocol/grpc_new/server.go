...
// DubboGrpcNewService is implemented by user logic struct wrapping ProviderBase generated by protoc-gen-connect.
type DubboGrpcNewService interface {
	// SetProxyImpl sets proxy. All invocation logics are embedded in impl.
	SetProxyImpl(impl protocol.Invoker)
	// GetProxyImpl gets proxy.
	GetProxyImpl() protocol.Invoker
	// BuildHandler receives user logic struct and handlerOption defined by connect to create handler.
...
// Server is GRPC_NEW server
type Server struct {
	httpServer *http.Server
}

// NewServer creates a new GRPC_NEW server
func NewServer() *Server {
	return &Server{}
}

// Start GRPC_NEW server
...
// Stop GRPC_NEW server
func (s *Server) Stop() {
	// todo: process error
	s.httpServer.Close()
}

// GracefulStop GRPC_NEW server
