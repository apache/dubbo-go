...
//
//	mockgen -copyright_file ../../.github/mockgen-copyright.txt -source base_invoker.go -destination ../mock/mock_invoker.go -self_package dubbo.apache.org/dubbo-go/v3/protocol/mock -package mock -exclude_interfaces AvailabilitySetter
//
