...
func (tp *TripleProtocol) Refer(url *common.URL) base.Invoker {
	...
	if ok || IDLMode == constant.NONIDL || isGenericCall {
		...
		logger.Error("[Server][Triple] dubbo3(old triple) and IDL-mode are not supported by dubbo-go any more, please use Triple protocol and regenerate stub code using latest [protoc-gen-go-triple](https://github.com/apache/dubbo-go/tree/main/tools/protoc-gen-go-triple)")
	}
	if err != nil {
