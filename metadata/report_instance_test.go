...
func TestDelegateMetadataReportGetServiceAppMapping(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		event, ok := metricEvent.(*metricsMetadata.MetadataMetricEvent)
		assert.True(t, ok)
		assert.Equal(t, metricsMetadata.MetadataMappingGet, event.Name)
		assert.NotNil(t, event.Start)
		assert.NotNil(t, event.End)
		assert.True(t, event.Succ)
		assert.Equal(t, "get", event.Attachment[metricsMetadata.MetadataMappingOperationKey])
		assert.Equal(t, "dubbo", event.Attachment[constant.InterfaceKey])
		assert.Equal(t, "dev", event.Attachment[constant.GroupKey])
		assert.Equal(t, "true", event.Attachment[metricsMetadata.MetadataMappingListenerRequestedKey])
	})
	t.Run("error", func(t *testing.T) {
...
func TestDelegateMetadataReportRegisterServiceAppMapping(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		event, ok := metricEvent.(*metricsMetadata.MetadataMetricEvent)
		assert.True(t, ok)
		assert.Equal(t, metricsMetadata.MetadataMappingRegister, event.Name)
		assert.NotNil(t, event.Start)
		assert.NotNil(t, event.End)
		assert.True(t, event.Succ)
		assert.Equal(t, "register", event.Attachment[metricsMetadata.MetadataMappingOperationKey])
		assert.Equal(t, "interfaceName", event.Attachment[constant.InterfaceKey])
		assert.Equal(t, "group", event.Attachment[constant.GroupKey])
		assert.Equal(t, "application", event.Attachment[constant.ApplicationKey])
	})
	t.Run("error", func(t *testing.T) {
...
func TestDelegateMetadataReportRemoveServiceAppMappingListener(t *testing.T) {
	...
	t.Run("normal", func(t *testing.T) {
		...
		event, ok := metricEvent.(*metricsMetadata.MetadataMetricEvent)
		assert.True(t, ok)
		assert.Equal(t, metricsMetadata.MetadataMappingRemove, event.Name)
		assert.NotNil(t, event.Start)
		assert.NotNil(t, event.End)
		assert.True(t, event.Succ)
		assert.Equal(t, "remove", event.Attachment[metricsMetadata.MetadataMappingOperationKey])
		assert.Equal(t, "interfaceName", event.Attachment[constant.InterfaceKey])
		assert.Equal(t, "group", event.Attachment[constant.GroupKey])
	})
	t.Run("error", func(t *testing.T) {
