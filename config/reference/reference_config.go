...
type ReferenceConfig struct {
	...
	Methods        []*method.MethodConfig `yaml:"methods"  json:"methods,omitempty" property:"methods"`
...
//		c.urls = registry.loadRegistries(c.Registry, config.consumerConfig.Registries, common.CONSUMER)
//
//		// set url to regURLs
...
//	// create proxy
//	if c.Async {
//		callback := instance.GetCallback(c.id)
//		c.pxy = extension.GetProxyFactory(config.consumerConfig.ProxyFactory).GetAsyncProxy(c.invoker, callback, cfgURL)
//	} else {
//		c.pxy = extension.GetProxyFactory(config.consumerConfig.ProxyFactory).GetProxy(c.invoker, cfgURL)
//	}
//}
//
//// Implement
...
//	urlMap.Set(constant.MODULE_KEY, config.consumerConfig.ApplicationConfig.Module)
//	urlMap.Set(constant.APP_VERSION_KEY, config.consumerConfig.ApplicationConfig.Version)
//	urlMap.Set(constant.OWNER_KEY, config.consumerConfig.ApplicationConfig.Owner)
//	urlMap.Set(constant.ENVIRONMENT_KEY, config.consumerConfig.ApplicationConfig.Environment)
//
//	// filter
