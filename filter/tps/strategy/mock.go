...
//
//	mockgen -copyright_file ../.github/mockgen-copyright.txt -source tps_strategy.go -destination tps/strategy/mock.go -package strategy -exclude_interfaces TpsLimitStrategyCreator
//
