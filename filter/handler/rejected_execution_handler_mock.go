...
//
//	mockgen -copyright_file ../.github/mockgen-copyright.txt -source rejected_execution_handler.go -destination handler/rejected_execution_handler_mock.go -package handler
//
...
func (m *MockRejectedExecutionHandler) RejectedExecution(url *common.URL, invocation base.Invocation) result.Result {
	m.ctrl.T.Helper()
