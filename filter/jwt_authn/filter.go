...
// Invoke processes the request and returns the result based on the JWT authentication.
// It forwards claims if necessary and returns an error result if JWT token is missing or verification fails.
